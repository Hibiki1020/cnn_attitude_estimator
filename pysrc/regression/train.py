...
if __name__ == '__main__':
    ...
    dropout_rate = CFG["hyperparameter"]["dropout_rate"]
    dim_fc_out = CFG["hyperparameter"]["dim_fc_out"]
    ...
    ##Network
    net = network_mod.Network(resize, dim_fc_out=dim_fc_out, dropout_rate=dropout_rate)
